...
public class NestedTransactionTest {
    ...
    @Qualifier("nestedBankingService")
    @Autowired
    ...
    @Test
    @DisplayName("1. 출금 후 롤백 (은행 거래 트랜잭션 = REQUIRED, 거래내역서 생성 트랜잭션 = NESTED)")
    void _01_rollback_REQUIRED_NESTED_1() {
        try {
    ...
    @Test
    @DisplayName("2-1. 거래 내역서 생성 후 롤백 (은행 거래 트랜잭션 = REQUIRED, 거래내역서 생성 트랜잭션 = NESTED)")
    void _10_rollback_REQUIRED_NESTED_2_1() {
        try {
    ...
    @Test
    @DisplayName("2-2. 거래 내역서 생성 후 롤백 (은행 거래 트랜잭션 = REQUIRED, 거래내역서 생성 트랜잭션 = NESTED)")
    void _03_rollback_REQUIRED_NESTED_2_2() {
    ...
    @Test
    @DisplayName("3. 뱅킹 서비스 끝나기 직전 롤백 (은행 거래 트랜잭션 = REQUIRED, 거래내역서 생성 트랜잭션 = NESTED)")
    void _04_rollback_REQUIRED_NESTED_3() {
        try {
